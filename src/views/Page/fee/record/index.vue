  ...
  <div class="flex p-4 fee-record">
    ...
    <div class="flex-1">
      <BasicTable @register="registerTable">
        <template #toolbar>
          <a-button type="primary" @click="handleCreate" :disabled="!currentOrgId">新增缴费记录</a-button>
        </template>
...
<script lang="ts" setup>
  ...
  const [registerTable, { reload }] = useTable({
    ...
    api: (params) => {
      ...
      return getFeeRecordPage({ communityId: currentOrgId.value, ...params });
    },
    columns,
    pagination: true,
    striped: true,
